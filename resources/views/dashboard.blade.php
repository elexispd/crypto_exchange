                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card revenue-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Deposits <span>| Total</span></h5>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6>${{ number_format($depositSum, 2) }}</h6>
                        ...
                        <div class="col-xxl-4 col-xl-12">
                            ...
                            <div class="card info-card customers-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">KYCs  <span>| Total</span></h5>
                                        ...
                                        <tbody>
                                            @foreach ($recentDeposits as $deposit)
                                                <tr>
                                                    ...
                                                    <td><a href="#" class="text-primary">{{ $deposit->currency }}</a></td>
